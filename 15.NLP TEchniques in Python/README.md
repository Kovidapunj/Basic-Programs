...
o	Function Used: word_tokenize(text) parses the string "Natural language processing is interesting" into a list of individual word strings.
...
o	Function Used: sent_tokenize(text) divides a paragraph into a list of sentences.
B. Stop Word Removal
